module mpi_c_bindings
    ...
    interface
        ...
        subroutine c_mpi_abort(comm, errorcode, ierr) bind(C, name="mpi_abort_wrapper")
            use iso_c_binding, only: c_int
        ...
        subroutine c_mpi_error_string(rcode, lstring, len, ierr) bind(C, name="mpi_error_string")
            use iso_c_binding, only: c_int, c_char
            integer(c_int), intent(in) :: rcode
            character(c_char), intent(in) :: lstring
            integer(c_int), intent(in) :: len
            integer(c_int), intent(out) :: ierr
        end subroutine c_mpi_error_string

    subroutine c_mpi_bcast_logical(buffer, count, datatype, root, comm, ierror) bind(C, name="mpi_bcast_logical_wrapper")
        use iso_c_binding, only : c_int
